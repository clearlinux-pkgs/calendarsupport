...
Version  : 24.02.0
Release  : 67
URL      : https://download.kde.org/stable/release-service/24.02.0/src/calendarsupport-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/calendarsupport-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/calendarsupport-24.02.0.tar.xz.sig
...
%prep
%setup -q -n calendarsupport-24.02.0
cd %{_builddir}/calendarsupport-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710436084
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6CalendarSupport.so.6.0.0
/usr/lib64/libKPim6CalendarSupport.so.6
/usr/lib64/libKPim6CalendarSupport.so.6.0.0
