...
%prep
%setup -q -n calendarsupport-19.12.0
cd %{_builddir}/calendarsupport-19.12.0
...
cp %{_builddir}/calendarsupport-19.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/calendarsupport/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5CalendarSupport.so.5.13.0
